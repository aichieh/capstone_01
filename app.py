...
take_HTN_medicine = ['take_HTN_medicine']
high_cholesterol = ['high_cholesterol']
take_HCL_medicine = ['take_HCL_medicine']
diabetes = ['diabetes']
stroke = ['stroke']
...
high_cholesterol_choice = st.sidebar.slider('Have high cholesterol', ('NO', 'YES'))
...
coronary_heart_disease_choice = st.sidebar.selectbox('Had any heart failure', ('NO', 'YES'))
